    ...
    <div className="min-h-screen bg-[#0b0618] text-white">
      ...
      >
        ...
        <div className="flex h-20 items-center border-b border-white/10 px-6">
          <div>
            ...
            <p className="mt-1 text-xs text-white/40">Admin Portal</p>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 p-4">
          <button className="flex w-full items-center gap-3 rounded-xl px-4 py-3 text-sm text-white/60 transition hover:bg-red-500/10 hover:text-red-400">
            <LogOut size={19} />
            Logout
          </button>
        </div>
      ...
      <main className="min-h-screen lg:ml-72">
        ...
        <header className="hidden h-20 items-center justify-between border-b border-white/10 bg-[#0b0618]/80 px-8 backdrop-blur-xl lg:flex">
          <div>
            <p className="text-sm text-white/40">Admin Portal</p>
